...
All files are code-owned SVG placeholders for the initial Observatory slice.
They are decorative only and must not carry financial meaning. Before release,
replace or refine against the approved source art / image generation and
inspect transparency at 2x.
